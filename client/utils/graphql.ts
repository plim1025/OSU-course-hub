...
export const ADD_TEXTBOOK_TO_COURSE = gql `
    mutation TextbookInfo($ISBN: String!, $title: String!, $author: String!, $coverImageURL: String
        $edition: Float!, $copyrightYear: Float!, $priceNewUSD: Float, $priceUsedUSD: Float, 
        $courseID: Float!, $termUsed: String!, $yearUsed: Float!) {
            addTextbookToCourse(input: {ISBN: $ISBN, title: $title, author: $author, coverImageURL: $coverImageURL
            edition: $edition, copyrightYear: $copyrightYear, priceNewUSD: $priceNewUSD, priceUsedUSD: $priceUsedUSD}, 
...
export const CREATE_COMMENT = gql `
    mutation createComment($text: String!, $ONID: String!, $professorID: Float, $courseID: Float, 
        $campus: String, $recommend: Boolean, $baccCore: Boolean, $gradeReceived: String,
        $tags: [String!]!){
        createComment(input: {text: $text, ONID: $ONID, professorID: $professorID, courseID: $courseID,
        campus: $campus, recommend: $recommend, baccCore: $baccCore, gradeReceived: $gradeReceived,
        tags: $tags}){
            comment {
                id
                text
